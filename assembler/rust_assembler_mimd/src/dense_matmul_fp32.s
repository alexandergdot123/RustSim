...
block r3, r10 
START_MUL: 
fpmac.32 r2, r3 #ALEX DON'T EVEN NEED SECOND ACCUMULATE INSTRUCTION, JUST DO AN FMAC
add r5, r4, r5
and r11, r11, 0
add r11, r11, 63
...
add r9, r9, r8
fpstoreacc.32 r5
sw r5, r9 #ALEX I NEED TO LOAD R5 USING GETACCUMULATE FOR FP32 FIRST
INF_LOOP: 
...
LAST_LOOP: 
lw r3, r2
fpadd.32 r4, r4, r3 #ALEX THIS NEEDS TO BECOME AN FP32 ADD
add r2, r2, 4
add r0, r0, 1
